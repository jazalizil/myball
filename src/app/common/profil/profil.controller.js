(function(){
	...
	function ProfilController($log, UserService) {
		...
		function getStats() {
			vm.statsDatas = [vm.me.stats.attack, vm.me.stats.defense, vm.me.stats.fairplay];
			vm.statsLabels = ["Attaque", "Defense", "Fairplay"];
			vm.statsColors = ["#FF518B", "#40D7FF", "#A6F14E"];
			vm.statsAverage = (vm.me.stats.attack + vm.me.stats.fairplay + vm.me.stats.defense) / 3;
			...
			/*vm.favoritesDatas = [180, 64, 21];
			 vm.favoritesLabels = ["Galaxy Stadium", "Urban Five", "Urban Foot"];
			 vm.favoritesColors = ["#50D2C2", "#6563A4", "#EE8F6E"];*/
